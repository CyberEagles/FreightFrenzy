...
@Disabled
@Autonomous
public class BlueBlockOnly extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (detector.getLocation()) {
            case LEFT:
                ...
                robot.goToPosition(-22,20,0.5,0,1,5,robot.STRAFELEFT);
                ...
                robot.goToPosition(-1,15,0.5,180,1,5, robot.STRAFELEFT);
                robot.turn(0.2,165,2,5);
                robot.drivedistance(45,0.5,5, robot.FORWARD);
                robot.drivedistance(25,0.5,5, robot.STRAFERIGHT);
                break;
            case RIGHT:
