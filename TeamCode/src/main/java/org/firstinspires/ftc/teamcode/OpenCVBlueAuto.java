    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (detector.getLocation()) {
            case LEFT:
                ...
                robot.drivedistance(19, 0.3, 5, robot.FORWARD);
                ...
                robot.goToPosition(-7.5, -25, 0.5, 50, 1.0, 5, robot.BACKWARD);
                robot.turn(0.2, 87, 3, 5);
                robot.drivedistance(14, 0.2, 5, robot.BACKWARD);
